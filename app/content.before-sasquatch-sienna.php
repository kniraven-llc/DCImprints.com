...
function dc_default_theme(): array
{
    return [
        'id' => 1,
        'theme_key' => 'dc-brown',
        'name' => 'DC Imprints Brown',
        'description' =>
            'The current DC Imprints brown, '
...
function dc_default_testimonials(): array
{
    $reviews = [
        ...
        [
            'Mike Frasier',
            'You’re not just another number at '
            . 'DC Imprints. They genuinely care '
            . 'about your experience, and Dan’s '
        ...
        [
            ...
            . 'was fast, pricing was clear, and we’ll '
    ...
    return [
        [
            ...
            'biography' =>
                ...
                . 'company’s history, local relationships, '
        ...
        [
            ...
            'biography' =>
                'Add a short approved introduction '
                . 'explaining this person’s experience '
